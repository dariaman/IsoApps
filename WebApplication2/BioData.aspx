                ...
                <div class="col-sm-4">
                    <div class="panel-body">
                        <div class="input-group">
                            ...
                            <asp:TextBox ID="TxtKeyWord" runat="server" class="form-control tip-bottom" placeholder="Search..." name="Search..." type="Search..."  data-original-title="Search Key"></asp:TextBox>
                ...
                <div class="col-sm-2">
                    <div class="panel-body">
                        <div class="form-group input-group">
                            ...
                            <asp:Button ID="btnAdd" runat="server" CssClass="btn btn-primary btn-block btn-flat tip-bottom" Text="Add New"
                                data-original-title="Click for add new BioData" />
                        </div>
                    </div>
                </div>
                ...
                <div class="col-sm-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-footer">
                            <div class="row">
                                <div class="col-sm-12">
                                    <asp:LinkButton ID="LinkUpload" runat="server" class="btn btn-primary  btn-block btn-group-vertical  tip-bottom "  data-original-title="Upload a Picture"><i class='fa fa-upload fa-fw'></i> Upload Picture<i class='fa fa-upload fa-fw'></i></asp:LinkButton>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            <asp:TextBox ID="txtBioDataCode" runat="server" MaxLength="5"  data-original-title="Input Biodata Code" CssClass="form-control  tip-bottom" placeholder="BioData Code.." name="BioData Code.." type="BioData Code.." onkeypress="return isKey(event)" ReadOnly="True"></asp:TextBox>
                        </div>
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    <asp:TextBox ID="txtBioDataname" runat="server" data-original-title="Input Biodata Name" MaxLength="100" CssClass="form-control tip-bottom" placeholder="BioData Name.." name="BioData Name.." type="BioData Name.." onkeypress="return isKey(event)"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            <asp:TextBox ID="txtBioDataNickname" runat="server" data-original-title="Input Nick Name" MaxLength="50" CssClass="form-control tip-bottom" placeholder="NickName.." name="NickName.." type="NickName.." onkeypress="return isKey(event)"></asp:TextBox>
                        </div>
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="panel">
                        <div class="panel-heading">
                            ...
                            <asp:TextBox ID="txtBioDataAdd" runat="server" onKeyUp="javascript:Check(this, 400);"
                                onChange="javascript:Check(this, 400);"  data-original-title="Input Address" MaxLength="500" Height="69px" TextMode="MultiLine" CssClass="form-control tip-bottom" placeholder="Address.." name="Address.." type="Address.." onkeypress="return isKey(event)"></asp:TextBox>
                        </div>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-sm-6">
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            <asp:TextBox ID="txtBioDataCity" runat="server" data-original-title="Input City" MaxLength="20" CssClass="form-control tip-bottom" placeholder="City.." name="City.." type="City.." onkeypress="return isKey(event)"></asp:TextBox>
                        </div>
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            <asp:TextBox ID="txtBioDataZIP" runat="server" data-original-title="Input zip code" MaxLength="10" CssClass="form-control tip-bottom" placeholder="Zip.." name="Zip.." type="Zip.." onkeypress="return isKey(event)"></asp:TextBox>
                        </div>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-sm-6">
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            <asp:TextBox ID="txtBioDataPhone" runat="server" data-original-title="Input Phone Number" MaxLength="20" CssClass="form-control tip-bottom" placeholder="Phone.." name="Phone.." type="Phone.." data-inputmask='"mask": "(9999) 999-99-999"' data-mask></asp:TextBox>
                        </div>
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            <asp:TextBox ID="txtBioDataFax" runat="server" data-original-title="Input Fax Number" MaxLength="20" CssClass="form-control tip-bottom" placeholder="Fax.." name="Fax.." type="Fax.." data-inputmask='"mask": "(9999) 999-99-999"' data-mask></asp:TextBox>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="panel">
                        <div class="panel-body">
                            <div class="form-group input-group">
                                ...
                                <asp:TextBox ID="txtBioDataEmail" runat="server" data-original-title="Input Email BioData" MaxLength="50" class="form-control tip-bottom" placeholder="Email" name="Email" type="Email" onkeypress="return isKey(event)"></asp:TextBox>
                            </div>
                        </div>
                        <div class="panel-footer">
                            <asp:RadioButtonList ID="RbGender" runat="server" RepeatDirection="Horizontal" CssClass="flat-red  tip-bottom" data-original-title="Select Gender">
...
<%--                    <div class="panel-body">
                    ...
                    <div class="panel">
                        <div class="panel-body ">
                            ...
                            <span class="input-group-addon calender-btn"> Birth Date <i class="fa fa-calendar fa-fw"></i></span>
                                <asp:TextBox ID="txtBioDataBirthDate" runat="server" class="form-control tip-bottom "  
                                    name="Date.." placeholder="Date.." data-original-title="input day birth" type="Date.." onkeypress="return isALLKeyDisable(event)"></asp:TextBox>
                                <span class="input-group-addon calender-btn"> <i class='fa fa-calendar fa-fw '></i></span>
                        ...
                        <div class="panel-footer">
                            <label>
                                <asp:CheckBox ID="chkAktiv" CssClass="flat-red  tip-bottom" runat="server" Checked="True" Text="IsActive" data-original-title="Click for Active / Non Active BioData" />
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            <asp:TextBox ID="txtBioDataContact" runat="server" data-original-title="Input BioData Contact" MaxLength="20" CssClass="form-control tip-bottom" placeholder="BioData Contact.." name="BioData Contact.." type="BioData Contact.." data-inputmask='"mask": "(9999) 999-99-999"' data-mask></asp:TextBox>
                        </div>
                        <div class="panel-footer">
                            <label>

                                <%--<asp:RadioButtonList ID="RbType" runat="server" RepeatDirection="Horizontal" CssClass="flat-red" data-toggle="tooltip" data-placement="top" data-original-title="Select Type">
