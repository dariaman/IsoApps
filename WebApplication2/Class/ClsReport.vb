...
Public Class clsReport
    ...
    Public Shared Sub RptKeyDS2(p As clsReport, pColl As clsReport.MSReportCollection, ByVal Key As String, param1 As String, param2 As String)
        Using con As New SqlConnection(config.MSSQLConnection)
            Dim cmd As New SqlCommand("SELECT * from MSReport2 where [no] =" & Key, con)
            Try
                con.Open()
                ...
                While dr.Read()
                    ...
                    p.DSstr1 = dr("DSstr1")
                    p.RptSql2 = dr("RptSql2") '& " '" & Key1 & "'" ', '" & Key2 & "', '" & Key3 & "'"
                    p.DSstr2 = dr("DSstr2")
                    p.Param1 = param1
                    p.Param2 = param2
                    p.Param3 = dr("Param3")
    ...
    Public Shared Sub Rpt2KeyDS2(p As clsReport, pColl As clsReport.MSReportCollection, ByVal Key As String, ByVal Key1 As String, param1 As String, param2 As String)
        Using con As New SqlConnection(config.MSSQLConnection)
            Dim cmd As New SqlCommand("SELECT * from MSReport2 where [no] =" & Key, con)
            Try
                con.Open()
    ...
    Public Shared Sub Rpt1Key(p As clsReport, pColl As clsReport.MSReportCollection, ByVal Key As String, ByVal Key1 As String, param1 As String, param2 As String)
        Using con As New SqlConnection(config.MSSQLConnection)
...
#Region "property"
    ...
    Public Property RptSql2() As String
        Get
            Return _RptSql2
        End Get
        Set(ByVal value As String)
    ...
    Public Property DSstr2() As String
        Get
            Return _DSstr2
        End Get
        Set(ByVal value As String)
...
#End Region
    ...
    Public Class MSReportCollection
        ...
        Public Sub viewrpt2(RV As ReportViewer, ReportPath As String, RptSql As String, RptSql2 As String, DsName As String, DsName2 As String, prm1 As String, prm2 As String, prm3 As String, prm4 As String, prm5 As String)
            Dim DSUtama As DataSet
            Dim DSUtama2 As DataSet
            With RV.LocalReport
                .ReportPath = ReportPath
                DSUtama = RptQuery(RptSql)
                DSUtama2 = RptQuery(RptSql2)
                Dim reportDS As ReportDataSource = New ReportDataSource(DsName, DSUtama.Tables(0))
                Dim reportDS2 As ReportDataSource = New ReportDataSource(DsName2, DSUtama.Tables(0))
                .ReportEmbeddedResource = ReportPath
                RV.ProcessingMode = ProcessingMode.Local
                .DataSources.Clear()
                .DataSources.Add(reportDS)
                .DataSources.Add(reportDS2)
                .DisplayName = "Report : " & DsName
                If Len(prm1) = 0 Then prm1 = " "
                If Len(prm2) = 0 Then prm2 = " "
                If Len(prm3) = 0 Then prm3 = " "
