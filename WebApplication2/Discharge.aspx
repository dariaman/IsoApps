                                            ...
                                            <td colspan="10" class="auto-table31">
                                                ...
                                                <asp:Panel ID="_pnl_btn_submit" runat="server">
                                                    <div class="col-sm-2" style="text-align:left">
                                                        <asp:Button ID="_btnSubmit" CssClass="btn btn-primary" runat="server" Text="Simpan" Visible="false"  ValidationGroup="next" OnClientClick="this.disabled=true;" UseSubmitBehavior="false"/>
                                                    </div>
                                                </asp:Panel>
                                                <div class="col-sm-2"></div>
                                                <div class="col-sm-1"></div>
                        ...
                        <div class="col-sm-12">
                            <div class="panel-body">
                                ...
                                <div class="panel-body" style="text-align:center">                                    
                                    <asp:Button ID="_btn_slip" CssClass="btn btn-primary" runat="server" Text="Cetak Slip" Width="15%" />
