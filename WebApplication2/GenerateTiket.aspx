<%@ Page Title="Upload & Download | Upload | Upload Claim" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="GenerateTiket.aspx.vb" Inherits="WebIsomedik.GenerateTiket" %>
            ...
            <div class="col-sm-4">
                <div class="panel-body">
                    <div class="form-group input-group">
                        <asp:Button ID="btnAdd" runat="server" CssClass="btn btn-primary btn-block btn-flat" Text="Generate Tiket"
                ...
                <div class="col-sm-12">
                    ...
                    <div class="box box-info">
                        <div class="box-header">
                            <h3 class="box-title">Tiket <small>List</small></h3>
                            ...
                            <div class="panel-body">
                                <div class="dataTable_wrapper">
                                    ...
                                    <asp:GridView ID="gridMenu" runat="server" AutoGenerateColumns="False" CssClass="table table-striped table-bordered table-hover"
                                        ...
                                        <Columns>
                                            <asp:TemplateField HeaderText="No Tiket" ItemStyle-ForeColor="#0000FF" ItemStyle-HorizontalAlign="Left">
                                                <ItemTemplate>
                                            ...
                                            <asp:BoundField DataField="TglBerobat" HeaderText="Tanggal Berobat" DataFormatString="{0:dd/MM/yyyy}" />
                                            <asp:BoundField DataField="NoPolis" HeaderText="No Polis" />
                                            <asp:BoundField DataField="TotalClaim" HeaderText="TotalClaim" DataFormatString="{0:N0}" />
    ...
    <asp:Panel ID="pnlPopup" runat="server" Visible="false" DefaultButton="BtnSubmit">
        <div class="row">
            ...
            <div class="col-sm-12">
                ...
                <div class="box box-info">
                    <div class="box-header">
                        <h3 class="box-title">Claim Foto <small>List</small>
                    ...
                    <table class="table table-striped table-bordered table-hover">
                        <tr>
                            <td style="vertical-align: central; text-align: start;">
                                <center><h3>Syarat & Ketentuan</h3></center>
                            </td>
