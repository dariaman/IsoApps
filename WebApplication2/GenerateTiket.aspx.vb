...
Public Class GenerateTiket
            ...
            If Not Page.IsPostBack Then
                If UserLogin.IsActive Then
                    Try
                        ...
                        txtMembId.Text = UserLogin.memberid
    ...
    Protected Sub btnAdd_Click(sender As Object, e As EventArgs) Handles btnAdd.Click
        ...
        Else
            ...
            Else
                txtNoTiket.Text = _ClsGenerateTiket.autoinc(UserLogin.UserId, txtTglBerobat.Text, txtNoPolis.Text, txtMembId.Text, Replace(txtTotalClaim.Text, ".", ""))
            End If
            bindData("%")
            txtTglBerobat.Text = Format(Today, "dd/MM/yyyy")
    ...
    Private Sub gridMenu_RowCommand(sender As Object, e As GridViewCommandEventArgs) Handles gridMenu.RowCommand
        Try
            ...
            If e.CommandName = "UpdateLink1" Then
                ...
                _sama.SendMail(Session("Email"), config.EmailClaim & ";" & "claimphoto@reliance-insurance.com", "Cancel Claim Tiket (" & KEY & ")", bodymsg, "", "", "")
    ...
    Protected Sub BtnSubmit_Click(sender As Object, e As EventArgs) Handles BtnSubmit.Click
        ...
        Try
            ...
            _sama.SendMail("claimphoto@reliance-insurance.com", config.EmailClaim & ";" & Session("Email"), "Foto Claim Tiket (" & txtNotiketPict.Text & ")", bodymsg, "", "", "")
