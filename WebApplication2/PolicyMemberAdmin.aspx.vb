...
Public Class PolicyMemberAdmin
    ...
    Protected Sub bindisiData(ALTMEMBID As String)
        Try
            Dim dt As New DataTable, dt1 As New DataTable, dt2 As New DataTable
            dt = _ClsPolicyMember.bindisiDataCard(ALTMEMBID)
            GVFC_Remain_Benefit.DataSource = _ClsPolicyMember.bindDataBenefitInfocard(ALTMEMBID)
            GVFC_Remain_Benefit.DataBind()

            GVVw_Claim_Info_Header.DataSource = _ClsPolicyMember.bindDataClaimInfocardHeader(ALTMEMBID)
