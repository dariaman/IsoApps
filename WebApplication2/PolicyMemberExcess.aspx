<%@ Page Title="Info | Info | Info Excess" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="PolicyMemberExcess.aspx.vb" Inherits="WebIsomedik.PolicyMemberExcess" %>
                ...
                <div class="col-sm-12">
                    ...
                    <div class="box box-info">
                        <div class="box-header">
                            <h3 class="box-title">Excess <small>List</small></h3>
                            ...
                            <div class="panel-body">
                                <div class="dataTable_wrapper">
                                    ...
                                    <asp:GridView ID="GVVw_Claim_Info_Header" runat="server" AllowPaging="True" AutoGenerateColumns="False" CssClass="table table-striped table-bordered table-hover" DataKeyNames="CLAIMNO" EmptyDataRowStyle-CssClass="empty_data" EmptyDataText="No data Found">
                                        <columns>
                                            <asp:TemplateField HeaderText="NO KLAIM" ItemStyle-ForeColor="#0000FF" ItemStyle-HorizontalAlign="Left" ControlStyle-CssClass="accordion-toggle" >
                                                <ItemTemplate>
                                            ...
                                            <asp:BoundField DataField="EXCESSAMT" HeaderText="EXCESS" DataFormatString="{0:N2}"/>
        ...
        <div id="DivBody1">
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="box box-info">
                        <div class="box-header">
                            <h3 class="box-title">INFORMASI <small>&nbsp;Excess Detail</small></h3>
