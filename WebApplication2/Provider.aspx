 <%@  Page Title="File | General | Provider List" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="Provider.aspx.vb" Inherits="WebIsomedik.Provider" %>
                ...
                <div class="col-sm-6">
                    <div class="panel-body">
                        <div class="form-group input-group">
                            ...
                            <asp:TextBox ID="TxtKeyWord" runat="server" class="form-control" placeholder="Input Range (KM)..." name="Input Range (KM)..." type="Input Range (KM)..." data-toggle="tooltip" data-placement="top" title="Input Key"  data-inputmask='"mask": "999"' data-mask></asp:TextBox>
                                    ...
                                    <div class="dataTable_wrapper">
                                        ...
                                        <asp:GridView ID="gridMenu" runat="server" AllowPaging="True" AutoGenerateColumns="False" CssClass="table table-striped table-bordered table-hover"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="RangeRS" HeaderText="JARAK KE RS TUJUAN (KM)"  DataFormatString="{0:N2}"/>
