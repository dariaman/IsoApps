...
Public Class Provider
    ...
    Protected Sub bindData(RangeRS As String, lat As String, longt As String, group As String)
        Try
            gridMenu.DataSource = _ClsProvider.bindData(Replace(RangeRS, "_", ""), lat, longt, group)
            gridMenu.DataBind()
        Catch ex As Exception
