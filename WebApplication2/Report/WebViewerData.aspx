<%@ Page Title="Report | Report | Viewer" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="WebViewerData.aspx.vb" Inherits="WebIsomedik.WebViewer" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="FrameContent" runat="server">
    <div class="row">
        <div class="col-sm-12">
            <div class="pnlfooter">
                <asp:Button ID="BtnExport01" runat="server" Text="Export Excel" CssClass="btn btn-primary btn-block btn-flat" Visible="FALSE" />
                <asp:Button ID="BtnExport1" runat="server" Text="Export PDF" CssClass="btn btn-primary btn-block btn-flat" Visible="true"/>
                <asp:Button ID="BtnPrint" runat="server" Text="Print To Printer" CssClass="btn btn-primary btn-block btn-flat" Visible="FALSE" />
            </div>
        </div>
    </div>
    <div class="row">
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="pnlfooter">
                ...
                &nbsp;<asp:Button ID="BtnExport" runat="server" Text="Export PDF" CssClass="btn btn-primary btn-block btn-flat" Visible="False" />
            </div>
        </div>
    </div>
</asp:Content>
