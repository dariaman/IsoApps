<%@ Page Title="File | Master | Unit List" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="Unit.aspx.vb" Inherits="WebApplication.Unit" %>
                    ...
                    <div class="panel-body">
                        <div class="form-group input-group">
                            ...
                            <asp:DropDownList ID="ddlSearch" runat="server" data-toggle="tooltip" data-placement="top" title="Select search type" class="form-control" placeholder="Type" name="Type" type="Type">
                                <asp:ListItem Value="Kode">Unit Code</asp:ListItem>
                                <asp:ListItem Value="Name">Unit Type</asp:ListItem>
                            </asp:DropDownList>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="panel-body">
                        <div class="form-group input-group">
                            ...
                            <asp:Button ID="btnAdd" runat="server" CssClass="btn btn-primary btn-block btn-flat" Text="Add New"
                                data-toggle="tooltip" data-placement="top" title="Click for add new Unit Group" />
                        </div>
                    </div>
                </div>
                <br />
            ...
            <div class="col-sm-12">
                <div class="box box-info">
                    <div class="box-header">
                        <h3 class="box-title">Unit <small>List</small></h3>
                        ...
                        <div class="panel-body">
                            <div class="dataTable_wrapper">
                                ...
                                <asp:GridView ID="gridMenu" runat="server" AllowPaging="True" AutoGenerateColumns="False" CssClass="table table-striped table-bordered table-hover"
                                    DataKeyNames="UnitCode" EmptyDataRowStyle-CssClass="empty_data" PagerStyle-CssClass="pagination"
                                    EmptyDataText="No data Found">
                                    <Columns>
                                        <asp:TemplateField HeaderText="Code Unit" ItemStyle-ForeColor="#0000FF" ItemStyle-HorizontalAlign="Left">
                                            <ItemTemplate>
                                                <asp:LinkButton ID="ImgViewUnitCode" runat="server" CausesValidation="False" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "UnitCode")%>' CommandName="SelectLink"><i class='fa fa-edit fa-fw'></i> <%# DataBinder.Eval(Container.DataItem, "UnitCode")%></asp:LinkButton>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                         ...
                                         <asp:TemplateField HeaderText="Status" ItemStyle-ForeColor="#0000FF" ItemStyle-HorizontalAlign="Left">
                                                <ItemTemplate>
                                                    ...
                                                    <asp:LinkButton ID="ImgViewActive" runat="server" CausesValidation="False"
                                                        ...
                                                        CommandArgument='<%# DataBinder.Eval(Container.DataItem, "UnitCode")%>' CommandName="UpdateLink"><i class='fa fa-signout fa-fw'></i>
                ...
                <div class="col-sm-6">
                    <div class="panel">
                        <div class="panel-heading">
                            Unit Code<i class="fa fa-code fa-fw"></i>
                        </div>
                        <div class="panel-body">
                            <asp:TextBox ID="txtUnitCode" runat="server" MaxLength="10" onkeypress="return isKey(event)" data-toggle="tooltip" data-placement="top" title="Input Unit Code" class="form-control" placeholder="Unit Code.." name="Unit Code.." type="Unit Code.."></asp:TextBox>
                        </div>
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="panel">
                        <div class="panel-heading">
                            Type Unit <i class="fa fa-code fa-fw"></i>
                        </div>
                        <div class="panel-body">
                            <asp:TextBox ID="txtUnittype" runat="server" MaxLength="50" onkeypress="return isKey(event)" data-toggle="tooltip" data-placement="top" title="Input Type Unit" class="form-control" placeholder="Type Unit.." name="Type Unit.." type="Type Unit.."></asp:TextBox>
                        </div>
                    </div>
                </div>
                <div class="col-sm-6">
                ...
                <div class="col-sm-12">
                    <div class="panel">
                        <div class="panel-footer">
                            <asp:CheckBox ID="chkAktiv" runat="server" Checked="True" Text="IsActive" data-toggle="tooltip" data-placement="top" title="Click ForActive /Non Active Unit" CssClass="flat-red" />
                        </div>
                    </div>
                </div>
            </div>
