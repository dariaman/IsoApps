<%@ Page Title="Upload & Download | Upload | Endorsment" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="UploadEndorsment.aspx.vb" Inherits="WebIsomedik.UploadEndorsment" %>
                                            ...
                                            <asp:TemplateField HeaderText="FIle" ItemStyle-ForeColor="#0000FF" ItemStyle-HorizontalAlign="Left">
                                                <ItemTemplate>
                                                    <asp:HiddenField ID="hffilename" runat="server" Value='<%# DataBinder.Eval(Container.DataItem, "FILENAME")%> ' />
                                                        ...
                                                        data-toggle="tooltip" data-placement="top" title='<%# IIf(DataBinder.Eval(Container.DataItem, "FILENAME") <> "", "Lihat File", "Tidak ada File")%>'
