    ...
    Private Sub gridMenu_RowCommand(sender As Object, e As GridViewCommandEventArgs) Handles gridMenu.RowCommand
        Try
            ...
            If e.CommandName = "UpdateLink" Then
                ...
                _sama.SendMail("admin.cc@reliance-insurance.com", config.EmailMembership & ";" & Session("Email"), "List Endorsment (" & KEY & flnm & ")", bodymsg, config.CCEmail, "", config.pathFileData & KEY & flnm)
