<%@ Page Title="Pengaturan | Daftar Role" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="UserRole.aspx.vb" Inherits="WebIsomedik.UserRole" %>
            ...
            <div class="col-sm-2">
                <div class="panel-body">
                    <div class="form-group input-group">
                        ...
                        <asp:Button ID="btnAdd" runat="server" CssClass="btn btn-primary  btn-block btn-flat tip-bottom" Text="Add New" data-original-title="Click for add new role" />
                    </div>
                </div>
            </div>
        </div>
        ...
        <div id="DivBody1">
            <table class="table table-striped table-bordered table-hover" id="mGridPict">
                <tr>
                    ...
                    <td style="vertical-align: central; text-align: center;">
                        <asp:LinkButton ID="LinkSubmit" runat="server" Text="" data-original-title="Submit Data" CssClass=" tip-bottom"> <p style="line-height: 0%;text-align: center;"><i class="fa fa-check" ></i> Submit</p></asp:LinkButton>
                    </td>
                </tr>
            </table>
            <div class="row">
                <div class="col-sm-6">
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            <asp:TextBox ID="txtRoleCode" runat="server" MaxLength="5" onkeypress="return isKey(event)" data-original-title="Input Role Code" class="form-control tip-bottom" placeholder="Role Code.." name="Role Code.." type="Role Code.."></asp:TextBox>
                        </div>
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            <asp:TextBox ID="txtRoleDesc" runat="server" MaxLength="50" onkeypress="return isKey(event)" data-original-title="Input Role Description" class="form-control tip-bottom" placeholder="Role Description.." name="Role Description.." type="Role Description.."></asp:TextBox>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="panel">
                        <div class="panel-body">
                            ...
                            <div class="panel-footer">
                                <asp:CheckBox ID="chkAdmin" runat="server" Text="Admin" data-original-title="Click for Admin or Not" CssClass="flat-red tip-bottom" />
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-sm-12">
                    <div class="panel">
                        <div class="panel-body">
                            ...
                            <div class="panel-footer">
                                <asp:CheckBox ID="chkAktiv" runat="server" Checked="True" Text="ISACTIVE?" data-original-title="Click for ACTIVE / Non ACTIVE Role" CssClass="flat-red tip-bottom" />
                            </div>
                        </div>
                    </div>
                </div>
