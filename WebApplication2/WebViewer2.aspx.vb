                ...
                If UserLogin.IsActive Then
                    Try
                        ...
                        If (Session("No") = "3") Then
                            clsReport.Rpt2KeyDS2(p, pColl, Session("No"), Session("Key1"), Session("Param1"), Session("Param2"))
                            pColl.viewrpt2(ReportViewer1, p.ReportPath, p.RptSql1, p.RptSql2, p.DSstr1, p.DSstr2, p.Param1, p.Param2, p.Param3, p.Param4, p.Param5)
                        End If
                        ...
                        With ReportViewer1.LocalReport
                            ...
                            DSUtama2 = clsrptcoll.RptQuery(p.RptSql2)
                            Dim reportDS As ReportDataSource = New ReportDataSource(p.DSstr1, DSUtama.Tables(0))
                            Dim reportDS2 As ReportDataSource = New ReportDataSource(p.DSstr2, DSUtama2.Tables(0))
