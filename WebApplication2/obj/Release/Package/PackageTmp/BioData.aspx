                ...
                <div class="col-sm-2">
                    <div class="panel-body">
                        <div class="form-group input-group">
                            ...
                            <asp:Button ID="btnAdd" runat="server" CssClass="btn btn-success btn-block btn-flat tip-bottom" Text="Add New"
                ...
                <div class="col-sm-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-footer">
                            <div class="row">
                                <div class="col-sm-12">
                                    <asp:LinkButton ID="LinkUpload" runat="server" class="btn btn-success  btn-block btn-group-vertical  tip-bottom "  data-original-title="Upload a Picture"><i class='fa fa-upload fa-fw'></i> Upload Picture<i class='fa fa-upload fa-fw'></i></asp:LinkButton>
                                </div>
                            </div>
                        </div>
                    </div>
