                                        ...
                                        <tr>
                                            ...
                                            <td >
                                                <asp:TextBox ID="_tbCardNo" runat="server" onkeypress="return isKey(event)"
                                                    MaxLength="50" class="form-control tip-bottom" placeholder="Isi Nomor Kartu Peserta..." name="Isi Nomor Kartu Peserta..." type="Isi Nomor Kartu Peserta..." data-original-title="Isi Nomor Kartu Peserta"></asp:TextBox>
                                            </td>
                                        </tr>                                        
                                        <tr>
                                            ...
                                            <td >
                                               <asp:TextBox ID="_tbreferral" runat="server" onkeypress="return isKey(event)" MaxLength="15" class="form-control tip-bottom" placeholder="Nomor Surat Rujukan" name="Nomor Surat Rujukan" type="Nomor Surat Rujukan"   data-original-title="Nomor Surat Rujukan" ></asp:TextBox>
                                            </td>
                                        </tr>
                                        <tr>
