<%@ Page Title="Report | Report | TOP 10 PROVIDER" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="ReportTop10Provider.aspx.vb" Inherits="WebIsomedik.ReportTop10Provider" %>
                    ...
                    <div class="panel-body">
                        <div class="form-group input-group">
                            ...
                            <asp:RadioButtonList ID="RBOption" runat="server">
                                <asp:ListItem Value="0">Claim Amount</asp:ListItem>
