...
<asp:Content ID="Content1" ContentPlaceHolderID="FrameContent" runat="server">
    <div id="DivBody1">
       ...
       <%-- <div class="row">
            <div class="col-lg-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-footer">
                        <div class="row">
                            <div class="col-lg-12">
                                <asp:LinkButton ID="LinkUpload" runat="server" class="btn btn-success  btn-block btn-group-vertical"  data-original-title="Upload a Picture"><i class='fa fa-upload fa-fw'></i> Up Load Picture<i class='fa fa-upload fa-fw'></i></asp:LinkButton>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <asp:Button ID="btnSave" runat="server" CssClass="btn btn-success  btn-block btn-flat" Text="Simpan" Visible="False" />
