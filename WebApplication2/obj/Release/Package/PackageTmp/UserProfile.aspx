                                ...
                                <td  colspan="2">
                                    ...
                                    <div class="row" style="visibility:hidden;">
                                        <div class="col-sm-12">
                                            <div class="panel panel-default">
                                                <div class="panel-body">
                                                    <center><asp:FileUpload ID="FileUpload1" runat="server"  CssClass="btn btn-success  btn-block btn-flat" Visible="False" />
                                                    <asp:LinkButton ID="LinkUpload" runat="server"  class="btn btn-success  btn-block btn-flat" Visible="False"><i class='fa fa-upload fa-fw'></i> Up Load</asp:LinkButton>
                                                    </center>
                                                </div>
                                            </div>
                                        </div>
        ...
        <div class="row" style="visibility:hidden;">
            ...
            <div class="col-sm-2">
                <div class="form-group input-group">
                    ...
                    <asp:Button ID="btnSubmit" runat="server" CssClass="btn btn-success  btn-block btn-flat tip-bottom" Text="Submit" data-original-title="Click for edit User" />
