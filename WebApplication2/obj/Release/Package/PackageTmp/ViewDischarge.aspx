                                            ...
                                            <td colspan="10">
                                                <asp:Panel ID="_pnl_action_close_discharge" runat="server">
                                                    <div style="text-align:center">
                                                        ...
                                                        <asp:Button ID="_btnSubmit" CssClass="btn btn-success" runat="server" Text="Setujui" Width="10%"  ValidationGroup="next" onClientClick="return confirm('Anda Yakin Ingin Menyetujui Discharge Ini?')"/>
                                                    </div>
                                                </asp:Panel>
                                                <asp:Panel ID="_pnl_action_reinput_discharge" runat="server" Visible="false">
                                                    <div style="text-align:center">
                                                        ...
                                                        <asp:Button ID="_btnSubmitReinput" CssClass="btn btn-success" runat="server" Text="Simpan" Visible="false"  ValidationGroup="next" OnClientClick="this.disabled=true;" UseSubmitBehavior="false"/>
                                                    </div>
                                                </asp:Panel>
                                            </td>
                                        </tr>
