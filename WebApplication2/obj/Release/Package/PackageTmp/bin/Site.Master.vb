    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Page.IsPostBack Then
            ...
            For i As Integer = 0 To dt.Rows.Count - 1
                'ltrlMenuhomeheader.Text = ltrlMenuhomeheader.Text & _ClsMenu.BindMenuHeader(dt.Rows(i)(0).ToString)
                ltrlMenuhome.Text = ltrlMenuhome.Text & _ClsMenu.BindMenu(Session("role"), UserLogin.UserId, dt.Rows(i)(0).ToString)
            Next
            'LblUser.Text = UserLogin.UserName
            LblUser1.Text = IIf(Len(UserLogin.UserName) < 20, Left(UserLogin.UserName & "                    ", 20), UserLogin.UserName)
            LblUser2.Text = Session("RoleDesc")
