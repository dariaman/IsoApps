    ...
    Public Function BindMenu(ByVal roleId As String, ByVal UserId As String, ByVal Group As String) As String
        Using con As New SqlConnection(config.MSSQLConnection)
            ...
            For Each categoryRow As DataRow In dsCat.Tables("MsMenuHeader").Rows
                ...
                strmenu = "<li class='submenu'> <a href='#'><i class='fa " & CType(categoryRow("PictHeader"), String) & " fa-fw'></i> <span>" & CType(categoryRow("MenuType"), String) & "</span> <span class='label label-important'></span></a>" & vbCrLf & _
                                "<ul>" & vbCrLf & _
                                    strmenucat & _
                            "</ul></li>" & vbCrLf
            ...
            Next
            strmenuheader = strmenu1
            If con.State = ConnectionState.Open Then con.Close()
            Return strmenuheader
        End Using
    End Function

    Public Function BindMenuHeader(ByVal Group As String) As String

        Dim strmenuheader As String = ""

        strmenuheader = "<li ><a data-toggle='tab' href='#" & Group & "'> " & Group & "</a>" & vbCrLf & _
                        "</li>"
