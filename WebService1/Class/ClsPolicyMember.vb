...
#End Region
    ...
    Public Function bindisiDataCard(ALTMEMBID As String) As DataTable
        Try
            Using con As New SqlConnection(config.MSSQLConnection)
                Dim cmd As New SqlCommand
                cmd.CommandType = CommandType.Text
                cmd.CommandTimeout = config.SQLtimeout
                cmd.Connection = con
                cmd.CommandText = " sp_s_vw_member_info_card_dtl '" & ALTMEMBID & "' "
                Try
                    Dim da As New SqlDataAdapter(cmd)
                    Dim dt As New DataTable
                    da.Fill(dt)
    ...
    Public Function bindDataClaimInfocardHeader(ALTMEMBID As String) As DataTable
        Try
            Using con As New SqlConnection(config.MSSQLConnection)
                Dim cmd As New SqlCommand
                cmd.CommandType = CommandType.Text
                ...
                cmd.Connection = con
                Try
                    cmd.CommandText = " sp_s_Vw_Claim_Info_card_Header '" & ALTMEMBID & "' "
                    Dim da As New SqlDataAdapter(cmd)
                    Dim dt As New DataTable
                    da.Fill(dt)
                    Return dt
    ...
    Public Function bindDataClaimInfoHeader(policyno As String, nemberid As String) As DataTable
        Try
            Using con As New SqlConnection(config.MSSQLConnection)
                ...
                cmd.Connection = con
                Try
                    cmd.CommandText = " sp_s_Vw_Claim_Info_card_Header '" & policyno & "', '" & nemberid & "' "
                    Dim da As New SqlDataAdapter(cmd)
                    Dim dt As New DataTable
                    da.Fill(dt)
                    Return dt
    ...
    Public Function bindDataBenefitInfo(policyno As String, nemberid As String) As DataTable
        ...
        End Try
    End Function
    Public Function bindDataBenefitInfocard(ALTMEMBID As String) As DataTable
        Try
            Using con As New SqlConnection(config.MSSQLConnection)
                Dim cmd As New SqlCommand
                cmd.CommandType = CommandType.Text
                ...
                cmd.Connection = con
                Try
                    cmd.CommandText = " select * from dbo.FC_Remain_Benefit_card( '" & ALTMEMBID & "') "
