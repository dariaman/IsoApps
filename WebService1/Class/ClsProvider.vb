...
#End Region
    ...
    Public Function bindData1(PROVIDERID As String, PROVIDERTYPE As String, SEARCH As String) As DataTable
        Try
            Using con As New SqlConnection(config.MSSQLConnection)
                ...
                cmd.Connection = con
                Dim txtsql As String = " Sp_S_PRV_PROVIDER_MASTER '" & PROVIDERID & "' ,'" & PROVIDERTYPE & "' ,'" & SEARCH & "'"
                Try
    ...
    Public Function bindData(RangeRS As String, lat1 As String, longt1 As String, group As String) As DataTable
        Try
            Using con As New SqlConnection(config.MSSQLConnection)
                Dim cmd As New SqlCommand
                cmd.CommandType = CommandType.Text
                cmd.CommandTimeout = config.SQLtimeout
                cmd.Connection = con
                Dim txtsql As String = " Sp_S_PRV_PROVIDER_MASTER_REL " & RangeRS & " ," & lat1 & " ," & longt1 & ",'" & group & "'"
                Try
                    cmd.CommandText = txtsql
